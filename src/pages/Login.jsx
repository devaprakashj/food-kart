    ...
    return (
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 sm:p-10">
                ...
                {error && (
                    <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 text-sm rounded-r-lg flex items-center gap-2 animate-shake">
                        <AlertCircle size={18} />
                        {error}
                    </div>
                )}
                ...
                <div className="mt-10 border-t border-gray-100 pt-8 text-center text-sm">
                    ...
                    <div className="mt-4 p-4 bg-gray-50 rounded-xl text-left border border-gray-100">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Demo Access</p>
                        <p className="text-xs text-gray-600">Please sign up first or use any dummy info after signing up once.</p>
                    </div>
                </div>
            </div>
        </div>
